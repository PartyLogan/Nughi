 ...
 * @return TRUE if the vent is successfully registers; otherwise false.
 */
KAPI b8 event_register(u16 code, void* listener, PFN_on_event on_event);

/**
 * @brief Unregister from listening when events are sent with the provided code. If not matching
 * registration is found, this function returns fales.
